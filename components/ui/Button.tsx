...
export default function Button({
  ...
  const variantStyles = {
    ...
    outline: 'border-2 border-primary-600 text-primary-700 bg-transparent hover:bg-primary-50 focus:ring-primary-500',
    ghost: 'text-primary-700 hover:bg-primary-50 focus:ring-primary-500',
    gradient: 'bg-gradient-to-r from-primary-600 to-primary-500 text-white hover:from-primary-700 hover:to-primary-600 shadow-md hover:shadow-xl hover:shadow-primary-500/30 border-0',
  };
